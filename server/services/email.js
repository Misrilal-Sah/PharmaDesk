...
export async function sendVerificationEmail(email, otp) {
  const mailOptions = {
    from: `"PharmaDesk" <${process.env.SMTP_EMAIL}>`,
    to: email,
      ...
      <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f8fafc;">
        ...
        <div style="background: #1565C0; padding: 25px; text-align: center;">
          ...
          <p style="color: rgba(255,255,255,0.8); margin: 10px 0 0; font-size: 12px;">
            This is a computer generated receipt. For any queries, contact us at ${process.env.SMTP_EMAIL || 'support@pharmadesk.com'}
          </p>
        </div>
      </div>
    `
